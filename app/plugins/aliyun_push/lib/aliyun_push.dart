...
class AliyunPush {
  ...
  Future<dynamic> _methodCallHandler(MethodCall call) async {
    switch (call.method) {
      case 'onNotification':
        return _onNotification?.call(call.arguments as Map<dynamic, dynamic>);
      case 'onNotificationReceivedInApp':
        return _onAndroidNotificationReceivedInApp?.call(
            call.arguments as Map<dynamic, dynamic>);
      case 'onMessage':
        return _onMessage?.call(call.arguments as Map<dynamic, dynamic>);
      case 'onNotificationOpened':
        return _onNotificationOpened?.call(call.arguments as Map<dynamic, dynamic>);
      case 'onNotificationRemoved':
        return _onNotificationRemoved?.call(call.arguments as Map<dynamic, dynamic>);
      case 'onNotificationClickedWithNoAction':
        return _onAndroidNotificationClickedWithNoAction?.call(
            call.arguments as Map<dynamic, dynamic>);
      case 'onChannelOpened':
        return _onIOSChannelOpened?.call(call.arguments as Map<dynamic, dynamic>);
      case 'onRegisterDeviceTokenSuccess':
        return _onIOSRegisterDeviceTokenSuccess?.call(
            call.arguments as Map<dynamic, dynamic>);
      case 'onRegisterDeviceTokenFailed':
        return _onIOSRegisterDeviceTokenFailed?.call(
            call.arguments as Map<dynamic, dynamic>);
    }
  }
